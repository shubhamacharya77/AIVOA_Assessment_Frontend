  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-xl border border-slate-100 p-8 relative z-10">
        ...
        <p className="text-sm text-slate-500 text-center mb-8">Join the Customer Complaint Copilot</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div>
            <label className="text-xs font-semibold text-slate-700 tracking-wide block mb-1.5">Full Name</label>
            <input 
              type="text" 
              required
              value={name}
